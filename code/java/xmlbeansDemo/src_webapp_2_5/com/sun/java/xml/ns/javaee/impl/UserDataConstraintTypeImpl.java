 ...
 */
public class UserDataConstraintTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.sun.java.xml.ns.javaee.UserDataConstraintType
{
    ...
    private static final javax.xml.namespace.QName TRANSPORTGUARANTEE$2 = 
        new javax.xml.namespace.QName("http://java.sun.com/xml/ns/javaee", "transport-guarantee");
    ...
    public java.util.List<com.sun.java.xml.ns.javaee.DescriptionType> getDescriptionList()
    {
        final class DescriptionList extends java.util.AbstractList<com.sun.java.xml.ns.javaee.DescriptionType>
        {
            ...
            {
                com.sun.java.xml.ns.javaee.DescriptionType old = UserDataConstraintTypeImpl.this.getDescriptionArray(i);
     ...
     */
    public com.sun.java.xml.ns.javaee.TransportGuaranteeType getTransportGuarantee()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sun.java.xml.ns.javaee.TransportGuaranteeType target = null;
            target = (com.sun.java.xml.ns.javaee.TransportGuaranteeType)get_store().find_element_user(TRANSPORTGUARANTEE$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTransportGuarantee(com.sun.java.xml.ns.javaee.TransportGuaranteeType transportGuarantee)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sun.java.xml.ns.javaee.TransportGuaranteeType)get_store().add_element_user(TRANSPORTGUARANTEE$2);
            }
     ...
     */
    public com.sun.java.xml.ns.javaee.TransportGuaranteeType addNewTransportGuarantee()
    {
        synchronized (monitor())
        {
            check_orphaned();
